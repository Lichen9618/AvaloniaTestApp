...
namespace Neo.Network.P2P.Payloads
{
    public abstract class BlockBase : IVerifiable
    {
        ...
        public UInt256 CrossStatesRoot;
        ...
        public virtual int Size => sizeof(uint) + PrevHash.Size + MerkleRoot.Size + sizeof(uint) + sizeof(uint) + sizeof(ulong) + NextConsensus.Size + sizeof(ulong) + CrossStatesRoot.Size+ 1 + Witness.Size;
        ...
        void IVerifiable.DeserializeUnsigned(BinaryReader reader)
        {
            ...
            CrossStatesRoot = reader.ReadSerializable<UInt256>();
        }
        ...
        public virtual JObject ToJson()
        {
            ...
            json["chainid"] = ChainID.ToString("x16");
            json["crossstatesroot"] = CrossStatesRoot.ToString();
