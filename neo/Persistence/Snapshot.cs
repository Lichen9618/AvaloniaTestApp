...
namespace Neo.Persistence
{
    public abstract class Snapshot : IDisposable, IPersistence, IScriptTable
    {
        ...
        public abstract DataCache<UInt256, StorageItem> CrossMerkleValue { get; }
        public abstract DataCache<UInt32Wrapper, CrossMerkleValueList> CrossMerkleTree { get; }
        ...
        public virtual void Commit()
        {
            ...
            Contracts.Commit();
            Storages.Commit();
            CrossMerkleValue.Commit();
            CrossMerkleTree.Commit();
