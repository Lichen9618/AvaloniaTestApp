...
namespace Neo.Persistence
{
    public abstract class Store : IPersistence
    {
        ...
        DataCache<UInt256, StorageItem> IPersistence.CrossMerkleValue => GetCrossMerkleValue();
        DataCache<UInt32Wrapper, CrossMerkleValueList> IPersistence.CrossMerkleTree => GetCrossMerkleTree();
        ...
        public abstract DataCache<UInt256, StorageItem> GetCrossMerkleValue();
        public abstract DataCache<UInt32Wrapper, CrossMerkleValueList> GetCrossMerkleTree();
