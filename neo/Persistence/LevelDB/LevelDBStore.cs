...
namespace Neo.Persistence.LevelDB
{
    public class LevelDBStore : Store, IDisposable
    {
        ...
        public override DataCache<UInt256, StorageItem> GetCrossMerkleValue()
        {
            return new DbCache<UInt256, StorageItem>(db, null, null, Prefixes.ST_CrossMerkleValue);
        }

        public override DataCache<UInt32Wrapper, CrossMerkleValueList> GetCrossMerkleTree()
        {
            return new DbCache<UInt32Wrapper, CrossMerkleValueList>(db, null, null, Prefixes.ST_CrossMerkleTree);
        }
