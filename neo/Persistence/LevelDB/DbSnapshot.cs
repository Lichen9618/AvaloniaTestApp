...
namespace Neo.Persistence.LevelDB
{
    internal class DbSnapshot : Snapshot
    {
        ...
        public override DataCache<UInt256, StorageItem> CrossMerkleValue { get; }
        public override DataCache<UInt32Wrapper, CrossMerkleValueList> CrossMerkleTree { get; }
        ...
        public DbSnapshot(DB db)
        {
            ...
            CrossMerkleValue = new DbCache<UInt256, StorageItem>(db, options, batch, Prefixes.ST_CrossMerkleValue);
            CrossMerkleTree = new DbCache<UInt32Wrapper, CrossMerkleValueList>(db, options, batch, Prefixes.ST_CrossMerkleTree);
